...
<body style="font-family: Arial, sans-serif; background-color: #f0f0f0; text-align: center;">
    ...
    <h1 style="color: #333;">User Registration</h1>

    <form action="register_process.php" method="POST" style="margin: 0 auto; width: 50%; background-color: #fff; padding: 20px; border-radius: 8px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
        ...
        <input type="submit" value="Register" style="background-color: #007bff; color: #fff; padding: 10px 20px; border: none; border-radius: 4px; cursor: pointer;">
